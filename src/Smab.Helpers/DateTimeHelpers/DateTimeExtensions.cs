...
public static class DateTimeExtensions {
	...
	extension(DateTime dateTime) {
		...
		public string ToDateShortMonthYearString() => dateTime.ToString(DD_MMM_YYYY);
	}
	...
	extension(DateOnly dateOnly) {
		...
		public string ToDateLongMonthYearString() => dateOnly.ToString(DD_MMMM_YYYY);
		...
		public string ToDateShortMonthYearString() => dateOnly.ToString(DD_MMM_YYYY);
	}
}
