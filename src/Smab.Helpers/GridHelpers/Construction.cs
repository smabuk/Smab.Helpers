...
public static partial class ArrayHelpers {
	extension<T>(Grid<T>) {
		...
		public static Grid<T> CreateFromArray(T[,] array) {
		...
		public static Grid<T> CreateFromRows(IEnumerable<IEnumerable<T>> rows) {
		...
		public static Grid<T> CreateFromColumns(IEnumerable<IEnumerable<T>> columns) {
		...
		public static Grid<T> CreateGrid(int cols, int rows, Func<int, int, T> initializer) {
