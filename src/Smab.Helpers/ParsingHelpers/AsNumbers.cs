...
public static partial class ParsingHelpers {
	...
	extension(string s) {
		...
		public IEnumerable<T> AsNumbers<T>(string? separator) where T : INumber<T> =>
		...
		public IEnumerable<T> AsNumbers<T>(char separator) where T : INumber<T> =>
			s.TrimmedSplit(separator).Select(s => s.As<T>());
		...
		public IEnumerable<T> AsNumbers<T>(string[]? separator = null) where T : INumber<T> =>
			separator is null
		...
		public IEnumerable<int> AsInts(string[]? separator = null) =>
		...
		/// string.</returns>
		public IEnumerable<long> AsLongs(string[]? separator = null) =>
	...
	extension(IEnumerable<string> s) {
		...
		public IEnumerable<IEnumerable<T>> AsNumbers<T>() where T : INumber<T> =>
